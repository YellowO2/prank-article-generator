    ...
    <div className="modal modal-open">
      <div className="modal-box relative">
        ...
        >
          ...
          <div className="mb-4 flex items-center justify-between text-sm text-base-content/80">
            <p>This article&apos;s rick roll has {viewCount} views :)</p>
            <a
              href="https://github.com/YellowO2/prank-article-generator"
              target="_blank"
