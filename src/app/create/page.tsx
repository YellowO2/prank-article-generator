        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <fieldset className="fieldset">
            ...
            <p className="text-sm text-base-content/70 mt-2 px-2">
              Make it catchy and believable (or unbelievably absurd!). This
          ...
          <fieldset className="fieldset">
            ...
            >
              ...
              <option value="breaking-news">Breaking News Alert</option>
              <option value="social-post">Social Media Post</option>
              {/* Add more options as you implement them */}
              {/* <option value="exclusive-video">Exclusive Video</option> */}
            </select>
            <p className="text-sm text-base-content/70 mt-2 px-2">
              Choose the disguise for your prank page.
            </p>
          </fieldset>
